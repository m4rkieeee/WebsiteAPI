        ...
        <main>
            <div style="text-align: center;">
                ...
                <div class="section">
                    ...
                    <div class="container">
                        <div class="z-depth-1 white lighten-4 row" id="loginContainer" style="display: inline-block; padding: 32px 48px 0 48px;background-color: white; border: 1px solid #000000;">
